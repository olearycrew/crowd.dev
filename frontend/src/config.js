...
const defaultConfig = {
  ...
  isGroupsionEnabled: import.meta.env.VUE_APP_IS_GROUPSIO_ENABLED,
};
...
const composedConfig = {
  ...
  isGroupsionEnabled: 'CROWD_VUE_APP_IS_GROUPSIO_ENABLED',
};
...
config.isGroupsioIntegrationEnabled = config.isGroupsionEnabled === 'true';
