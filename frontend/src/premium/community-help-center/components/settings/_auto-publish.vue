  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-radio label="all">
          All channels
          <span class="text-gray-500 ml-2 font-normal">All conversations will automatically be
            published</span>
        </el-radio>
...
const channelsList = computed(() => Object.values(activeIntegrationsList.value).reduce(
  (acc, item) => {
    if (
